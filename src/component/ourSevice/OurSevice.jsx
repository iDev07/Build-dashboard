...
import { DELETE_SERVICE } from "./../../redux/actions/types";
...
export const OurSevice = () => {
  ...
  const handleOk = () => {
    ...
    dispatch(deleteAction("ourService", DELETE_SERVICE, selectedID));
    setTimeout(() => {
      setVisible(false);
  ...
  const editHandleOk = () => {
    form
      ...
      .then((values) => {
        ...
        dispatch(
          updateAction("ourService", UPDATE_SERVICE, selectedEditID.id, values)
        );
        dispatch(getAction("ourService", GET_SERVICES));
      })
      .catch((info) => {
  ...
  const createHandleOk = () => {
    form
      ...
      .then((values) => {
        ...
        .then((res) => {
          dispatch(
            createAction("ourService", CREATE_SERVICE, {
              name: values.name,
